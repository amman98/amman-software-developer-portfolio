...
export default function Resume() {
    ...
    return (
        <div className="footer">
            <a target="_blank" rel="noreferrer" href="https://github.com/amman98">
                <img className='footer-icon' src={github} alt="GitHub profile" />
            </a>
            <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/amman-nega/">
                <img className='footer-icon' src={linkedin} alt="LinkedIn profile" />
            </a>
            <a target="_blank" rel="noreferrer" href="https://twitter.com/JCailton">
